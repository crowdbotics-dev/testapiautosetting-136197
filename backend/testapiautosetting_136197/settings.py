"""
Django settings for testapiautosetting_136197 project.
...
ROOT_URLCONF = 'testapiautosetting_136197.urls'
...
WSGI_APPLICATION = 'testapiautosetting_136197.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "TestAPIAutoSettings3z09uf Support <support@testapiautosetting-136197.botics.co>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "testapiautosetting_136197 API",
    "DESCRIPTION": "API documentation for testapiautosetting_136197 App",
    "VERSION": "v1",
}
